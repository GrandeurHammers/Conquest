...
for (var i = 0; i < pointToLetter.length; i++) {
    ...
    "${pointToLetter[i]}\r{0}".format(floor(abs(zone${pointToLetter[i]}Progress))), zoneLocations[${i}] + 2 * Vector.UP, 3, Clip.NONE, WorldTextReeval.VISIBILITY_AND_STRING, Color.${condition.color}, SpecVisibility.DEFAULT)
